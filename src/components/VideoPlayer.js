...
export default class VideoPlayer extends Component {
	...
	renderTopControls() {
		...
		return(
			<Animated.View style={[
				...
				<ImageBackground
					source={ require( '../images/video/top-vignette.png' ) }
	...
	renderVolume() {
		...
		return (
			<View style={ styles.volume.container }>
				...
				>
					<Image style={ styles.volume.icon } source={ require( '../images/video/volume.png' ) } />
				</View>
			</View>
		);
	}
	...
	renderFullscreen() {
		...
		let source = this.state.isFullscreen === true ? require( '../images/video/shrink.png' ) : require( '../images/video/expand.png' );
		return this.renderControl(
			<Image source={ source } />,
			this.methods.toggleFullscreen,
	...
	renderBottomControls() {
		...
		return(
			<Animated.View style={[
				...
				<ImageBackground
					source={ require( '../images/video/bottom-vignette.png' ) }
					style={[ styles.controls.column ]}
					imageStyle={[ styles.controls.vignette ]}>
					{ seekbarControl }
					<View style={[
	...
	renderPlayPause() {
		...
		let source = this.state.paused === true ? require( '../images/video/play.png' ) : require( '../images/video/pause.png' );
		return this.renderControl(
			<Image source={ source } />,
		...
		if ( this.state.loading ) {
			return (
				<View style={ styles.loader.container }>
					<Animated.Image source={ require( '../images/video/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
		...
		if ( this.state.error ) {
			return (
				<View style={ styles.error.container }>
					<Image source={ require( '../images/video/error-icon.png' ) } style={ styles.error.icon } />
