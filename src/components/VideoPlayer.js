...
export default class VideoPlayer extends Component {
	...
	renderStartButton() {
		...
		return (
			...
			>
				<Image style={[{width:64,height:64,opacity:0.8},customStyles.playButton]}
		...
		return (
			<View style={[styles.controls, customStyles.controls]}>
				<TouchableOpacity
					...
					style={[{padding:8},customStyles.controlButton, customStyles.playControl]}
				>
					<Image
						style={[{width:24,height:24,opacity:0.8}, customStyles.controlIcon, customStyles.playIcon]}
						source={this.state.isPlaying ? require('../images/video/pause.png') : require('../images/video/play.png')}
					/>
				</TouchableOpacity>
				{this.renderSeekBar()}
				{this.renderTime()}
			...
			<View style={customStyles.videoWrapper}>
				...
				>
					<TouchableOpacity
						...
						onPress={() => {
							if(this.state.isControlsVisible&&this.state.isPlaying){
					...
					>
						{this.state.isLoading && <ActivityIndicator style={this.getSizeStyles()}/>}
					</TouchableOpacity>
...
VideoPlayer.propTypes = {
	...
	customStyles: PropTypes.shape({
		...
		controlIcon: Image.propTypes.style,
		playIcon: Image.propTypes.style,
		...
		playArrow: Image.propTypes.style,
	}),
